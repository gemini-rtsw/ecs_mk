...
w -64 99 100 0 n#1 junction -96 96 -32 96 dev2Ctrl.dev2Ctrl#544.flnk
w -384 899 100 0 n#2 stopShtrs.stopShtrs#564.bsStop -544 896 -224 896 junction
w -128 227 100 0 n#2 junction -224 224 -32 224 dev2Ctrl.dev2Ctrl#544.state
...
w -432 963 100 0 n#3 stopShtrs.stopShtrs#564.tsFlnk -544 960 -320 960 -320 544 -32 544 dev2Ctrl.dev2Ctrl#534.flnk
...
w -288 1059 100 0 n#4 stopShtrs.stopShtrs#564.tsStop -544 1056 -32 1056 -32 672 dev2Ctrl.dev2Ctrl#534.state
w 480 547 100 0 n#5 dev2Ctrl.dev2Ctrl#534.flink 448 544 512 544 512 -736 -944 -736 -944 -416 -896 -416 parkNew1.parkNew1#681.tsFlnkIn
w 464 99 100 0 n#6 dev2Ctrl.dev2Ctrl#544.flink 448 96 480 96 480 -704 -928 -704 -928 -448 -896 -448 parkNew1.parkNew1#681.bsFlnkIn
...
w -208 643 100 0 n#7 junction -384 640 -32 640 dev2Ctrl.dev2Ctrl#534.pos
w -352 1251 100 0 n#8 moveShtrs.moveShtrs#563.bsPos -544 1248 -160 1248 -160 -416 -448 -416 parkNew1.parkNew1#681.bsPosOut
w -96 195 100 0 n#8 junction -160 192 -32 192 dev2Ctrl.dev2Ctrl#544.pos
...
w 480 227 100 0 n#21 dev2Ctrl.dev2Ctrl#544.carMess 448 224 512 224 512 192 608 192 ecars.ecars#458.IMSS
w 528 259 100 0 n#22 dev2Ctrl.dev2Ctrl#544.car 448 256 608 256 ecars.ecars#458.IVAL
w 480 675 100 0 n#23 dev2Ctrl.dev2Ctrl#534.carMess 448 672 512 672 512 640 608 640 ecars.ecars#328.IMSS
w 528 707 100 0 n#24 dev2Ctrl.dev2Ctrl#534.car 448 704 608 704 ecars.ecars#328.IVAL
...
xform 0 -736 1328
use dev2Ctrl -32 455 100 0 dev2Ctrl#534
xform 0 208 624
...
use dev2Ctrl -32 7 100 0 dev2Ctrl#544
xform 0 208 176
